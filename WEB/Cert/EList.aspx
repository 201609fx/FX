<%@ Page Theme="Pop" StylesheetTheme="Pop"  Language="C#" AutoEventWireup="true" CodeFile="EList.aspx.cs" Inherits="Cert_EList" %>
...
window.onload=function(){
   window.parent.document.getElementById("FrameEList").style.height = document.body.scrollHeight;
} 
</script>
</head>
<body>
    <form id="form1" runat="server">
      <asp:GridView ID="gvEList" runat="server" AutoGenerateColumns="false" BorderWidth="0"    BackColor="#979797" cellspacing="1" cellpadding="0" Width="100%" OnRowCommand="gvEList_RowCommand" ShowHeader="true"  ShowFooter="true" >
	            ...
	            <Columns>	
	            <asp:TemplateField HeaderText="名称" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="270">
			  <ItemTemplate>
			  ...
			  <asp:TextBox ID="txtFdes" runat="server" Width="97%"></asp:TextBox>
			       ...
			       <asp:TemplateField HeaderText="型号" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="270">
			  <ItemTemplate>
