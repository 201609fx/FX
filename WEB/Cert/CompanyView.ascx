<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CompanyView.ascx.cs" Inherits="Cert_CompanyView" %>
                ...
                <tr> 
                  <td><table width="787" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        ...
                        <td background="../img/intro_body_3.gif" class="bt-hui"><asp:Label runat="server" ID="lblSortName">记录提示</asp:Label></td>
