<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LeftMenu.ascx.cs" Inherits="Contact_LeftMenu" %>
                  ...
                  <td><table width="193" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td><table width="193" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              ...
                              <td background="../img/intro_4.gif"><img src="../img/intro_19.gif" width="66" height="33"></td>
                      ...
                      <tr> 
                        <td background="../img/intro_6.gif"><table width="182" border="0" align="center" cellpadding="0" cellspacing="2">
                            <tr> 
                              <td height="25" bgcolor="#EFEFEF">&nbsp;&nbsp;<img src="../img/ico2.gif" width="3" height="11">&nbsp;<a class="link-03" href="default.aspx?m=../PopWindow/ShowNews&id=1">联系我们</a></td>
                            </tr>
                            <tr> 
