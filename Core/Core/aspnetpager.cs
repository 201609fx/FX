...
namespace SZMA.Core
{
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (null != CloneFrom && string.Empty != CloneFrom.Trim())
            {
                ...
                if (null == ctrl)
                {
                    ...
                    if (null == errStr)
                        errStr = "The control \" %controlID% \" does not exist or is not of type SZ12345.Core.AspNetPager!";
    ...
    internal sealed class SR
    {
        private SR()
        {
            _rm = new System.Resources.ResourceManager("SZMA.Core.AspNetPager", base.GetType().Assembly);
        }
