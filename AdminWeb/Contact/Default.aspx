...
<body>
  ...
  <tr> 
    <td valign="top"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td class="left-bt">&nbsp;<img src="../img/body_ico_bt.gif" width="6" height="6">&nbsp;联系我们</td>
        </tr>
		<tr> 
          <td height="8"></td>
        </tr>
    ...
    <table width="96%" border="0" cellspacing="0" cellpadding="0" class="main-text">
										...
										<tr>
											...
											<td valign="middle" width="90%">
											    <FTB:FreeTextBox id="ftbContent2"  runat="server" Width="90%" Height="100%" AutoConfigure="Default" HelperFilesPath="../Control/FreeTexoBox/ftb/HelperScripts/"  ButtonPath="../Images/ftb/office2003/" ImageGalleryPath="/UploadFiles/FTBimages/"></FTB:FreeTextBox>
											 
											</td>
										</tr>
										<tr>
											<td height="200" width="10%">首页概要：<font color="red">*</font></td>
											<td valign="middle" width="90%">
