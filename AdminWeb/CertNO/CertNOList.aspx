<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CertNOList.aspx.cs" Inherits="CertNO_CertNOList" %>
          ...
          <TABLE cellSpacing="1" cellPadding="3" width="100%" border="0" class="main-text" id="tabMySearch">
            <tr>
             ...
             <tr style="display:none;">
                ...
                <td bgColor="#f5f5f1" width="40%" align="left"><asp:TextBox runat="server" ID="txtMainSCNO" Width="95%"></asp:TextBox></td>
                  <td class="leftTitle" bgColor="#f9f9f0" width="10%" align="right">记录编号：</td>
                <td bgColor="#f5f5f1" width="40%" align="left"><asp:TextBox runat="server" ID="txtNoteNum" Width="95%"></asp:TextBox>
                </td>
            </tr>
              <tr style="display:none;">
                <td class="leftTitle" bgColor="#f9f9f0" width="10%" align="right">原证书：</td>
                <td bgColor="#f5f5f1" width="40%" align="left"><asp:TextBox runat="server" ID="txtOldCertNO" Width="95%"></asp:TextBox></td>
                  <td class="leftTitle" bgColor="#f9f9f0" width="10%" align="right">新获证书：</td>
                <td bgColor="#f5f5f1" width="40%" align="left"><asp:TextBox runat="server" ID="txtCertNO" Width="95%"></asp:TextBox>
                </td>
            </tr>
             <tr>
                <td class="leftTitle" bgColor="#f9f9f0" width="10%" align="right">申请类型：</td>
                <td bgColor="#f5f5f1" width="40%" align="left"> <asp:DropDownList runat="server" ID="ddlType" Font-Size="12px" Width="95%">
                <asp:ListItem Text='选择一个类型' Value=''></asp:ListItem>
                  ...
                  <td class="leftTitle" bgColor="#f9f9f0" width="10%" align="right">证书状态：</td>
