<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CertNO_Edit.aspx.cs" Inherits="CertNO_CertNO_Edit" %>
...
<body>
  ...
  <tr> 
    ...
    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">      
        ...
        <tr> 
          <td class="left-bt" colspan="3">&nbsp;<img src="../img/body_ico_bt.gif" width="6" height="6">&nbsp;<asp:Label runat="server" ID="lblSortName">证书发放</asp:Label></td>
        </tr>
		<tr> 
    ...
    <tr>
        <td bgColor="#f5f5f1" colspan="4" align=center>
            ...
            <input type="button" value="返 回" Class="button" id="btnBack" onclick="location.href='Default.aspx'" />
        </td>
    </tr>
    <tr height="6"></tr>
     <tr bgcolor="#E7E2D6"> 
