<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompanyList.aspx.cs" Inherits="CompanyAdd_CompanyList" %>
        ...
        <tr> 
         ...
         <asp:GridView ID="gvList" runat="server" Width="100%" BorderWidth="0" cellpadding="0" cellspacing="1"
	            ...
	            <Columns>		           
		            ...
		            <asp:TemplateField HeaderText="申请方" ItemStyle-Width="40%">
			            <ItemStyle HorizontalAlign="left" />
			            <ItemTemplate>
			                <a class="link-02" target="_blank" href="../workaround/FirstAuditingDetail.aspx?mid=<%#((System.Data.DataRowView)Container.DataItem)["ID"]%>&tid=<%# ((System.Data.DataRowView)Container.DataItem)["Type"] %>" >
		            ...
		            <asp:TemplateField HeaderText="初审状态" ItemStyle-Width="10%">
		                <ItemStyle HorizontalAlign="left" />
			            <ItemTemplate>
		            ...
		            <asp:TemplateField HeaderText="编辑" ItemStyle-Width="4%">
		                <ItemStyle HorizontalAlign="center" />
			            <ItemTemplate>
				              <a class="link-02" style="cursor:hand"  id="UnPass" href="Default.aspx?id=<%#((System.Data.DataRowView)Container.DataItem)["ID"]%>">编辑</a>
				             </ItemTemplate>
		            </asp:TemplateField>
