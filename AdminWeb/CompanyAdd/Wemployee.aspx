<%@ Page Language="C#" Theme="Pop" StylesheetTheme="Pop"  AutoEventWireup="true" CodeFile="Wemployee.aspx.cs" Inherits="Cert_Wemployee" %>
...
window.onload=function(){
   window.parent.document.getElementById("FrameWemployee").style.height = document.body.scrollHeight;
} 
...
<body>
  ...
  <asp:GridView ID="gvWemployee" runat="server" AutoGenerateColumns="false" BorderWidth="0"  BackColor="#979797" cellspacing="1" cellpadding="0" Width="100%" OnRowCommand="gvWemployee_RowCommand" ShowHeader="true"  ShowFooter="true" OnRowDataBound="gvList_RowDataBound" >
