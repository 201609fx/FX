<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompanyLogList.aspx.cs" Inherits="CompanyAdd_CompanyLogList" %>
        ...
        <tr> 
         ...
         <asp:GridView ID="gvList" runat="server" Width="100%" BorderWidth="0" cellpadding="0" cellspacing="1"
	            ...
	            <Columns>		           
		            ...
		            <asp:TemplateField HeaderText="申请方" ItemStyle-Width="24%">
			            <ItemStyle HorizontalAlign="left" />
			            <ItemTemplate>
			                <a class="link-02" href="../workaround/FirstAuditingDetailMainSC.aspx?mid=<%#((System.Data.DataRowView)Container.DataItem)["MainSCID"]%>&tid=<%# ((System.Data.DataRowView)Container.DataItem)["Type"]%>" >
		            ...
		            <asp:TemplateField HeaderText="申请时间" ItemStyle-Width="10%">
		               ...
		               <asp:TemplateField HeaderText="类型" ItemStyle-Width="10%">
		                <ItemStyle HorizontalAlign="left" />
			            <ItemTemplate>
				            &nbsp;<%#getType(((System.Data.DataRowView)Container.DataItem)["Type"].ToString())%>
			            </ItemTemplate>
		            </asp:TemplateField>
		            
		            <asp:TemplateField HeaderText="证书号" ItemStyle-Width="8%">
			            <ItemStyle HorizontalAlign="left" />
			            <ItemTemplate>
		            ...
		            <asp:TemplateField HeaderText="编辑" ItemStyle-Width="4%">
		                <ItemStyle HorizontalAlign="center" />
			            <ItemTemplate>
				              <a class="link-02" style="cursor:hand"  id="UnPass" href="CompanyLogEdit.aspx?id=<%#((System.Data.DataRowView)Container.DataItem)["MainSCID"]%>">编辑</a>
				             </ItemTemplate>
		            </asp:TemplateField>
