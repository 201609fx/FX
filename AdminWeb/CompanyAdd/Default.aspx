<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="CompanyAdd_Default" %>
...
<body>
  ...
  <tr> 
    ...
    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="main-text">
        ...
        <tr> 
          <td class="left-bt" colspan="3">&nbsp;<img src="../img/body_ico_bt.gif" width="6" height="6">&nbsp;<asp:Label runat="server" ID="lblSortName" CssClass="main-text">申请</asp:Label></td>
        </tr>
		<tr> 
...
<table width="97%" border="0" align="right" cellpadding="0" cellspacing="0" class="main-text">
          ...
          <tr>
          <td bgcolor="#f9f9f0" align="center"><span class="text-star-12">*</span>原证书号</td>
          ...
          <td colspan="7" bgColor="#f5f5f1"><asp:TextBox runat="server" ID="txtCompany" Width="99%"></asp:TextBox></td>
          </tr>
