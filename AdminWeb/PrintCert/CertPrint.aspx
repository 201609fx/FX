<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CertPrint.aspx.cs" Inherits="PrintCert_CertPrint" %>
...
<tr>
<td><dxwc:ReportViewer ID="CertReport1" runat="server" BorderStyle="Inset" Width="412px"/></td>
</tr>
<tr align="center">
...
<td><OBJECT id="factory" viewastext name="factory" style="DISPLAY:none;WIDTH:1px;HEIGHT:1px" codebase="../scriptx/smsx.cab#Version=6,3,436,14" classid="clsid:1663ed61-23eb-11d2-b92f-008048fdd814">   
 ...
 <asp:Button ID="Button1" runat="server" Text="打印" OnClick="Button1_Click" Visible="false" />
