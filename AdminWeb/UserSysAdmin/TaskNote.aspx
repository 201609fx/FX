<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaskNote.aspx.cs" Inherits="UserSysAdmin_TaskNote" %>
...
<body>
  ...
  <tr> 
    ...
    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td class="left-bt" colspan="3">&nbsp;<img src="../img/body_ico_bt.gif" width="6" height="6">&nbsp;<asp:Label runat="server" ID="lblSortName">用户任务提示管理</asp:Label></td>
        </tr>
     ...
     <tr><td colspan="3"  height="10"></td></tr>
       ...
       <tr>
       <td align="right" valign="bottom"> 关键字:
        ...
        <tr> 
         ...
         <asp:GridView ID="gvList" runat="server" Width="100%" BorderWidth="0" cellpadding="0" cellspacing="1"
	            ...
	            <Columns>		           
		            ...
		            <asp:TemplateField HeaderText="用户名" ItemStyle-Width="15%">
		            ...
		            <asp:TemplateField HeaderText="真实姓名" ItemStyle-Width="15%">
			            <ItemStyle HorizontalAlign="Center" />
			            <ItemTemplate>			                
		            ...
		            <asp:TemplateField HeaderText="任务提示" ItemStyle-Width="55%">
		                <ItemStyle HorizontalAlign="center" />
			            <ItemTemplate>
				            <%#((System.Data.DataRowView)Container.DataItem)["TaskName"].ToString()%>
			            </ItemTemplate>
		            </asp:TemplateField>
		            <asp:TemplateField HeaderText="操作" ItemStyle-Width="10%">
		                <ItemStyle HorizontalAlign="Center" />
			            <ItemTemplate>				      
			            <a class="link-02"  href="TaskNateEdit.aspx?id=<%#((System.Data.DataRowView)Container.DataItem)["ID"]%>" >编辑</a>	
			            </ItemTemplate>
		            </asp:TemplateField>
	            </Columns>
            </asp:GridView>
