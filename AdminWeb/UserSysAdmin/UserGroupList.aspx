<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserGroupList.aspx.cs" Inherits="UserSysAdmin_UserGroupList" %>
...
<body>
  ...
  <tr> 
    ...
    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td class="left-bt" colspan="3">&nbsp;<img src="../img/body_ico_bt.gif" width="6" height="6">&nbsp;<asp:Label runat="server" ID="lblSortName">用户组管理</asp:Label></td>
        </tr>
		<tr> 
        ...
        <tr> 
          ...
          <tr><td colspan="3"  height="10"></td></tr>    <tr><td colspan="3" > 
       <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="main-text">
       <tr>
       <td align="right" valign="bottom">
       关键字:<asp:TextBox runat="server" ID="txtKey" Width="150"></asp:TextBox>
        ...
        <tr> 
         ...
         <asp:GridView ID="gvList" runat="server" Width="100%" BorderWidth="0" cellpadding="0" cellspacing="1"
	            ...
	            <Columns>		           
		            ...
		            <asp:TemplateField HeaderText="用户组名称" ItemStyle-Width="35%">
		            ...
		            <asp:TemplateField HeaderText="系统保留" ItemStyle-Width="10%">
		                <ItemStyle HorizontalAlign="center" />
			            <ItemTemplate>
				            <%#((System.Data.DataRowView)Container.DataItem)["IsSys"].ToString()=="0"?"否":"是"%>
			            </ItemTemplate>
		            </asp:TemplateField>	
		              <asp:TemplateField HeaderText="修改者" ItemStyle-Width="20%">
			            <ItemStyle HorizontalAlign="Center" />
			            <ItemTemplate>			                
		            ...
		            <asp:TemplateField HeaderText="操作" ItemStyle-Width="15%">
		                <ItemStyle HorizontalAlign="Center" />
			            <ItemTemplate>				      
			            <a class="link-02"  href="UserGroup_edit.aspx?id=<%#((System.Data.DataRowView)Container.DataItem)["ID"]%>" >编辑</a>			            
			            <asp:LinkButton runat="server" CssClass="link-02"  CommandArgument='<%#((System.Data.DataRowView)Container.DataItem)["ID"].ToString()+","+((System.Data.DataRowView)Container.DataItem)["IsSys"].ToString()%>' ID="LinkButton3" CommandName="del" Text="删除" OnLoad="LinkCategory_Load2"  ></asp:LinkButton>	
			            </ItemTemplate>
		            </asp:TemplateField>
	            </Columns>
            </asp:GridView>
