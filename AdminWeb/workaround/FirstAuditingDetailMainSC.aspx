<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FirstAuditingDetailMainSC.aspx.cs" Inherits="workaround_FirstAuditingDetailMainSC" %>
<html>
...
<body>
  ...
  <tr> 
    ...
    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
           <td class="left-bt" colspan="3">&nbsp;
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr><td width="20%" style="height: 18px"  class="left-bt">
          <img src="../img/body_ico_bt.gif" width="6" height="6">&nbsp;<asp:Label runat="server" ID="lblSortName">申请资料</asp:Label></td>
          <td width="100%" align="center" style="height: 18px">
          <asp:LinkButton CssClass="link-02" ID="lnkbtn1" runat="server" OnClick="lnkbtn1_Click">资料审核</asp:LinkButton>&nbsp;&nbsp;
          <asp:LinkButton CssClass="link-02" ID="lnkbtn2" runat="server" OnClick="lnkbtn2_Click">现场评审</asp:LinkButton>&nbsp;&nbsp;
          <asp:LinkButton CssClass="link-02" ID="lnkbtn3" runat="server" OnClick="lnkbtn3_Click">评审结论</asp:LinkButton>&nbsp;&nbsp;
          <asp:LinkButton CssClass="link-02" ID="lnkbtn4" runat="server" OnClick="lnkbtn4_Click">处理通知书</asp:LinkButton>&nbsp;&nbsp;
          <asp:LinkButton CssClass="link-02" ID="lnkbtn5" runat="server" OnClick="lnkbtn5_Click">报批申请</asp:LinkButton>&nbsp;&nbsp;
          <asp:LinkButton CssClass="link-02" ID="lnkbtn6" runat="server" OnClick="lnkbtn6_Click">领证明细</asp:LinkButton>&nbsp;&nbsp;
          </td>
          </tr>
              </table>
          </td>
       ...
       <tr><td colspan="3"  height="10"></td></tr>
        <tr> 
          ...
          <tr>
          <td width="11%" bgcolor="#f9f9f0">所属区域</td>
          <td width="10%" bgColor="#f5f5f1"><asp:Label runat="server" ID="lblAreaID" Width="100%"></asp:Label></td>
          <td bgcolor="#f9f9f0">法人代表</td>
          <td bgColor="#f5f5f1"><asp:Label runat="server" ID="lblFrdb" Width="100%"></asp:Label></td>
          <td bgcolor="#f9f9f0">联系电话</td>
          <td bgColor="#f5f5f1"><asp:Label runat="server" ID="lblFtel" Width="100%"></asp:Label></td>
         ...
         <tr>
          ...
          runat="server" AutoGenerateColumns="false" BorderWidth="0"   BackColor="#9D9DA1" cellspacing="1" ShowHeader="true" cellpadding="0" Width="100%"  style="font-size:12px;">
	            ...
	            <asp:TemplateField HeaderText="维修业务" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="450">        
          ...
          runat="server" AutoGenerateColumns="false" BorderWidth="0"   BackColor="#9D9DA1" cellspacing="1" ShowHeader="true" cellpadding="0" Width="100%"  style="font-size:12px;">
			   ...
			   <asp:TemplateField HeaderText="特约维修业务品牌" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="350">
			  <ItemTemplate>
          ...
          <td bgcolor="#f5f5f1" colspan="6"><asp:GridView ID="gvMemployee" runat="server" Width="100%" BorderWidth="0" cellpadding="0" cellspacing="1"
	            ...
	            <Columns>		           
		            <asp:TemplateField HeaderText="序号">
		             ...
		             <asp:BoundField ItemStyle-Width="10%" HeaderText="学历" DataField="educational" />	
		              <asp:BoundField ItemStyle-Width="15%" HeaderText="岗位" DataField="Eposition" />	 
		               ...
		               <asp:BoundField ItemStyle-Width="15%" HeaderText="证书编号" DataField="certNO" />	
		                <asp:BoundField ItemStyle-Width="15%" HeaderText="备注" DataField="remark" />           
	            </Columns>
            </asp:GridView></td>
          </tr>
           ...
           <td rowspan="2"> <asp:GridView ID="gvEList" runat="server" Width="100%" BorderWidth="0" cellpadding="0" cellspacing="1"
	            ...
	            <Columns>		           
		            ...
		            <asp:TemplateField HeaderText="型号">
			            <ItemStyle Width="40%" HorizontalAlign="center" />
			            <ItemTemplate>
				            <%#((System.Data.DataRowView)Container.DataItem)["Model"]%>
			            </ItemTemplate>
		            </asp:TemplateField>
          ...
          <td bgcolor="#f5f5f1" colspan="6"><asp:GridView ID="gvCSFile" runat="server" Width="100%" BorderWidth="0" cellpadding="0" cellspacing="1"
	            ...
	            <Columns>		           
		            <asp:TemplateField HeaderText="序号">
		             ...
		             <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20%" HeaderText="份数" DataField="Num" DataFormatString="{0}份" />          
	            </Columns>
            </asp:GridView></td>
          </tr>
     ...
     <script language="javascript" >
          ...
          <td colspan="8" bgColor="#f5f5f1" align="center">&nbsp;         </td>
        </tr>
          </table>
