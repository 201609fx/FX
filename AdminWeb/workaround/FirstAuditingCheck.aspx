<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FirstAuditingCheck.aspx.cs" Inherits="workaround_FirstAuditingCheck" %>
...
<body>
    ...
    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
       ...
       <tr><td colspan="3"  height="10"></td></tr>
        <tr> 
          ...
          <tr>
          <td bgcolor="#f9f9f0">所属区域</td>
          <td bgColor="#f5f5f1" ><asp:Label runat="server" ID="lblAreaID" Width="100%"></asp:Label></td>
         ...
         <tr>
          ...
          runat="server" AutoGenerateColumns="false" BorderWidth="0"   BackColor="#9D9DA1" cellspacing="1" ShowHeader="true" cellpadding="0" Width="100%"  style="font-size:12px;">
			   ...
			   <asp:TemplateField HeaderText="特约维修品牌" ItemStyle-HorizontalAlign="left" ItemStyle-Width="350">
			  <ItemTemplate>
		             ...
		             <asp:BoundField ItemStyle-Width="15%" HeaderText="学历" DataField="educational" />	
		              <asp:BoundField ItemStyle-Width="15%" HeaderText="岗位" DataField="Eposition" />	 
		               ...
		               <asp:BoundField ItemStyle-Width="15%" HeaderText="证书编号" DataField="certNO" />	  
		                <asp:BoundField ItemStyle-Width="10%" HeaderText="备注" DataField="remark" />           
	            </Columns>
            </asp:GridView></td>
          </tr>
 ...
 <script language="javascript" >
          ...
          <td colspan="8" bgColor="#f5f5f1" align="center">&nbsp; <asp:Button ID="btnPass" runat="server" Text="通过" OnClick="btnPass_Click" /> &nbsp;&nbsp;
          <input type="button" id="btnUnPass" onclick="OpenUnPass('<%=Request.QueryString["mid"] %>','<%=Request.QueryString["tid"] %>')" value="退回" />&nbsp;&nbsp;
           <input type="button" id="btnBack" onclick="window.location.href='FirstAuditing.aspx?tid='+'<%=Request.QueryString["tid"] %>';" value="返回" />&nbsp;&nbsp;</td>
        </tr>
          </table>
