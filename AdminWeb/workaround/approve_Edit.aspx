<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approve_Edit.aspx.cs" Inherits="workaround_approve_Edit" %>
    ...
    <tr>    
        <td class="leftTitle" bgColor="#f5f5f1" align="right" colspan="6">&nbsp;
            ...
            <td align="right" colspan="2">  
                  会长:<asp:TextBox runat="server" ID="txtSuperintendent"  Width="120" CssClass="input-line">  </asp:TextBox>&nbsp;<cc1:DatePicker ID="dpSTime" runat="server" Width="120"/>&nbsp;&nbsp;
            </td>       
            </tr>           
            </table>                  
        </td>
