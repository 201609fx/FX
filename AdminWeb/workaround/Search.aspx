<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="workaround_Search" %>
              ...
              function OpenDetail(id1,id2)
                {
	                ...
	                var Url = '../workaround/FirstAuditingDetail.aspx?mid='+id1+'&tid='+id2;
...
<body>
  ...
  <tr> 
    ...
    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td class="left-bt" colspan="3">&nbsp;<img src="../img/body_ico_bt.gif" width="6" height="6">&nbsp;<asp:Label runat="server" ID="lblSortName">查询</asp:Label></td>
        </tr>
		<tr> 
       ...
       </tr>  <tr><td colspan="3" class="text-b" style="cursor:hand" onclick="SetTabDisplay()" align="left">
       ...
       <td colspan="3">
        ...
        <tr> 
         ...
         <asp:GridView ID="gvList" runat="server" Width="100%" BorderWidth="0" cellpadding="0" cellspacing="1"
	            BackColor="#9D9DA1" style="font-size:12px;" AutoGenerateColumns="false" OnRowCommand="gvList_RowCommand"  OnRowDataBound="gvList_RowDataBound" >
	            ...
	            <Columns>		           
		            ...
		            <asp:TemplateField HeaderText="操作" ItemStyle-Width="25%">
		                <ItemStyle HorizontalAlign="Center" />
			            <ItemTemplate> 
			            <asp:DropDownList runat="server" ID="ddlState">
			            </asp:DropDownList>
			             <asp:LinkButton runat="server" CssClass="link-02"  CommandArgument='<%# ((System.Data.DataRowView)Container.DataItem)["ID"].ToString()+",,"+(Container.DataItemIndex).ToString()%>' ID="LinkButton1" CommandName="ok" Text="修改" ></asp:LinkButton>
			             <asp:LinkButton runat="server" CssClass="link-02"  CommandArgument='<%# ((System.Data.DataRowView)Container.DataItem)["ID"].ToString()+",,"+(Container.DataItemIndex).ToString()%>' ID="LinkButton2" CommandName="see" Text="查看" ></asp:LinkButton>
...
<asp:Panel runat="server" ID="pnlSee" Visible="false">
            ...
            <tr>
                <td class="leftTitle" bgColor="#f9f9f0" width="10%" align="right">企业名称：</td>
                <td bgColor="#f5f5f1"  align="left" colspan="3"><asp:TextBox runat="server" ID="txtCompany1" Width="98%"></asp:TextBox>
                <asp:Label ID="lblMainSCID" Visible="false" runat="server"></asp:Label>
                </td>
            </tr>
             <tr>
                <td class="leftTitle" bgColor="#f9f9f0" width="10%" align="right">申请编号：</td>
                <td bgColor="#f5f5f1" width="40%" align="left"><asp:TextBox runat="server" ID="txtMainSCNO1" Width="95%"></asp:TextBox></td>
                  <td class="leftTitle" bgColor="#f9f9f0" width="10%" align="right">记录编号：</td>
                <td bgColor="#f5f5f1" width="40%" align="left"><asp:TextBox runat="server" ID="txtNoteNum1" Width="95%"></asp:TextBox>
                </td>
            </tr>
             <tr>
                  <td class="leftTitle" bgColor="#f9f9f0" width="10%" align="right">申请状态：</td>
                ...
                <asp:ListItem Text='选择一个状态' Value=''></asp:ListItem>
                 ...
                 <td class="leftTitle" bgColor="#f9f9f0" width="10%" align="left" colspan="2">                    
        <asp:Button ID="btnSave" runat="server" Text="修改状态" OnClick="btnSave_Click" /></td>
            </tr>          
