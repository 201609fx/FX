<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lastApprove.aspx.cs" Inherits="workaround_lastApprove" %>
             ...
             <script language="javascript" >
               function OpenPrint(id)
                ...
                function OpenDetail(id)
                {
	                var features = 'width=800,height=700,scrollbars=yes,left=50,top=50,resizable=yes';
	                var winName = '报批申请表明细';
	                var Url = 'lastApproveDetail.aspx?id=' + id;
	                var win = window.open(Url, winName, features);
	                win.focus();
                }
</script>
         ...
         <asp:GridView ID="gvList" runat="server" Width="100%" BorderWidth="0" cellpadding="0" cellspacing="1"
	            ...
	            <Columns>		           
		            ...
		            <asp:TemplateField HeaderText="编辑" ItemStyle-Width="5%">
		                <ItemStyle HorizontalAlign="Center" />
			            <ItemTemplate>				      
			            <a class="link-02" style="cursor:hand;display:<%#((System.Data.DataRowView)Container.DataItem)["ApproveID"].ToString()==""?"none":"table-row" %>;"  href="lastApprove_edit.aspx?id=<%#((System.Data.DataRowView)Container.DataItem)["ID"]%>" >编辑</a>	
			            </ItemTemplate>
		            </asp:TemplateField>
