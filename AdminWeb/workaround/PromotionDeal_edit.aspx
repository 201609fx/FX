<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PromotionDeal_edit.aspx.cs" Inherits="workaround_PromotionDeal_edit" %>
    ...
    <title>无标题页</title>
        <link href="../styles/style.css" rel="stylesheet" type="text/css">
               ...
               function OpenPrint(id)
                ...
                function selectChang(a,stra,strb)
{
...
<body>
  ...
  <tr> 
    ...
    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">      
        ...
        <tr> 
          <td class="left-bt" colspan="3">&nbsp;<img src="../img/body_ico_bt.gif" width="6" height="6">&nbsp;<asp:Label runat="server" ID="lblSortName">通知书编辑</asp:Label></td>
        </tr>
		<tr> 
    ...
    <tr>    
        <td class="leftTitle" bgColor="#f5f5f1" align="right" colspan="6">&nbsp;
            ...
            <tr  bgColor="#f5f5f1" >
            <td align="center">&nbsp;&nbsp;
            <asp:DropDownList runat="server" ID="ddlResult" DataTextField="des" DataValueField="ID" onchange="javascript:selectChang(this,'ddlResult','txtLevel')">
            </asp:DropDownList>     
             <asp:TextBox ID="txtLevel" runat="server" Width="150" style="display:none"></asp:TextBox>         
            </td>
            </tr>
            ...
            <tr bgColor="#f5f5f1">
             <td align="right">  
                  日期:<cc1:DatePicker ID="dpLTime" runat="server" Width="120"/>
            </td>
            </tr>
            </table>                  
        </td>
    ...
    <tr>
        <td bgColor="#f5f5f1" colspan="6" align=center>
            ...
            <input type="button" value="返 回" Class="button" id="btnBack" onclick="location.href='PromotionDeal.aspx'" />&nbsp;&nbsp;
            <input type="button" value="打 印" Class="button" id="btnPrint" onclick="OpenPrint('<%=Request.QueryString["id"] %>')" />
        </td>
    </tr>
    <tr height="6"></tr>
     <tr bgcolor="#E7E2D6"> 
