<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FirstCheckDetail.aspx.cs" Inherits="workaround_FirstCheckDetail" %>
  ...
  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
      <td><table width="570" border="0" align="center" cellpadding="0" cellspacing="0">
		            ...
		            <asp:TemplateField HeaderText="序号">
		              ...
		              <asp:BoundField ItemStyle-Width="45%" HeaderText="项目" DataField="Name" />		           
		               <asp:TemplateField HeaderText="提交情况">
			            ...
			            <tr>
			            <td onclick=""><asp:CheckBox ID="chk1" Enabled="false"  runat="server"  Checked='<%#((System.Data.DataRowView)Container.DataItem)["IsCheck"].ToString()=="1"?true:false %>' onclick="setchk(this)"/>
                 已<%#((System.Data.DataRowView)Container.DataItem)["des"]%></td>
			            <td onclick=""><asp:CheckBox ID="chk2" Enabled="false"  runat="server" Checked='<%#((System.Data.DataRowView)Container.DataItem)["IsCheck"].ToString()=="1"?false:true %>' onclick="setchk(this)" />未<%#((System.Data.DataRowView)Container.DataItem)["des"]%>
                         </td>
			            </tr>
			            </table>
          ...
          <input type="button" name="btnPrint" onclick="OpenPrint('<%=Request.QueryString["mid"] %>','<%=Request.QueryString["tid"] %>')" value="打 印" />
          </td>
          </tr>
          <tr>
            <td><table width="570" border="0" cellspacing="0" cellpadding="0">
