<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Complain_History.aspx.cs" Inherits="workaround_Complain_History" %>
         ...
         <asp:GridView ID="gvList" runat="server" Width="100%" BorderWidth="0" cellpadding="0" cellspacing="1"
	            ...
	            <Columns>		           
		            ...
		            <asp:TemplateField HeaderText="名称">
			            ...
			            <ItemTemplate>
			            <a class="link-02"  style="cursor:hand;" onclick="javascript:OpenPrint('<%#((System.Data.DataRowView)Container.DataItem)["ID"].ToString()%>')">
