<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Law_Default" %>
  ...
  <tr> 
    ...
    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
                ...
                <td background="../img/list_top_2.gif" class="body-bt" width="100%">&nbsp;列表</td>
                <td width="16"><img src="../img/list_top_3.gif" width="16" height="32"></td>
       </tr>
        <tr> 
          <td colspan="3">
         <asp:GridView ID="gvList" runat="server" Width="96%" BorderWidth="0" cellpadding="0" cellspacing="1"
	            ...
	            <Columns>		           
		            ...
		            <asp:TemplateField HeaderText="标题" ItemStyle-Width="50%">
			            ...
			            <ItemTemplate>
			                <a class="link-02" href="ShowNews.aspx?id=<%#((System.Data.DataRowView)Container.DataItem)["ID"]%>&pid=2" target="_blank">
		            ...
		            <asp:TemplateField HeaderText="操作" ItemStyle-Width="12%">
			            ...
			            <ItemTemplate>
				           ...
				           <asp:LinkButton runat="server" CssClass="link-02" CommandArgument='<%# ((System.Data.DataRowView)Container.DataItem)["ID"]%>' ID="lnkbtnDel" CommandName="del1" Text="删除" OnLoad="LinkCategory_Load"></asp:LinkButton>
			            </ItemTemplate>
		            </asp:TemplateField>
	            </Columns>
            </asp:GridView>
